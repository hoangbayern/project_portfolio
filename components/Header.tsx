...
export default function Header() {
  const {activeMenu, setActiveMenu} = useActiveMenuScrollContext();
  ...
  return (
    <header className="z-[999] relative">
      ...
      >
        ...
        texr-[0.9rem] font-medium text-gray-500 sm:w-[initial] sm:flex-nowrap sm:gap-5"
        >
          {links.map((link) => (
            <motion.li
            ...
            >
              <Link
                className="flex items-center justify-center w-full px-2 py-3
